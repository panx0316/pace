            ...
            <ul>
              ...
              <li>
				...
				<?php foreach ($actividades as $data_actividades){ 
                  ...
                  <li><a href="#"><?php echo $data_actividades->P_NOMBRE_ACTIVIDAD." - Fecha Inicio:". FormatearFechaES($data_actividades->P_FECHA_INICIO)." / Fecha Término:". FormatearFechaES($data_actividades->P_FECHA_TERMINO)." / Avance:". $data_actividades->P_PORC_AVANCE."%" ?></a><button type="button" class="btn btn-link" data-id="<?php echo $data_actividades->P_ID_ACTIVIDAD; ?>">Editar</button></li>
				  <?php } }  ?>
                </ul>
              </li>
				  <?php } }  ?>
